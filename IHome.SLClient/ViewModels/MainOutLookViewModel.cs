    ...
    public class MainOutLookViewModel : INotifyPropertyChanged
    {
        ...
        public MainOutLookViewModel()
        {
            string menulist = "["
                            ...
                            + ",{header:'基础设置',item_list:[{name:'小区管理',type_name:'IHome.SLClient.InfoManagement.CommunityView',xap_name:'IHome.SLClient.InfoManagement.zip'},{name:'楼盘字典'},{name:'数据字典'},{name:'区域板块'},{name:'数据字典'},{name:'推送配置'},{name:'业务参数'},{name:'个人管理'},{name:'个人信息管理'},{name:'业务报表'}]}"
